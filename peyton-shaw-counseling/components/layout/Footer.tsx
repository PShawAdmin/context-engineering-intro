        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a 
                href="https://www.psychologytoday.com/us/therapists/peyton-shaw-grapevine-tx/1184171" 
                ...
                aria-label="Psychology Today Profile"
                target="_blank"
              ...
              <a 
                href="https://x.com/PShawCounseling" 
                className="w-10 h-10 rounded-full bg-grey-storm hover:bg-nude-clay flex items-center justify-center transition-all duration-200 hover:scale-110"
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.512 11.24h-6.67l-5.22-6.826-5.986 6.826H1.654l7.73-8.82L1.5 2.25h6.832l4.713 6.231 5.199-6.231z"/>
                </svg>
              </a>
              <a 
                href="#" 
