    ...
    <section className="section-padding bg-background-dove relative overflow-hidden">
      ...
      <div className="container relative z-10">
            ...
            >
              <CardHeader className="pb-4 pt-6 px-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-grey-storm font-medium">{testimonial.rating}.0</span>
                </div>
              </CardHeader>
              <CardBody className="px-6 pb-6">
                <blockquote className="mb-6">
                  <p className="text-text-storm leading-relaxed italic">
                    &quot;{testimonial.content}&quot;
                  </p>
                </blockquote>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-nude-sand to-grey-blue-light flex items-center justify-center">
                        <span className="text-sm font-semibold text-text-charcoal">
        ...
        <div className="mt-16 text-center">
          <div className="flex flex-wrap justify-center items-center gap-8 text-grey-storm">
